...
!     Store single values as the maximum of either the x or y-momentum
      if(drovx_avg > drovy_avg) then
          d_max = drovx_max; d_avg = drovx_avg; ij_max = ijx_max; ngmax = ngxmax
      else
          d_max = drovy_max; d_avg = drovy_avg; ij_max = ijy_max; ngmax = ngymax
      end if
...
!     Write a short human readable output summary to the screen.
      ...
      fmt_step = '(a,i6,a,e10.3,a,i4,a,i4,a,i4,a,e10.3)'
      write(msg_bfr,fmt_step) 'iteration ', av%nstep, ', d_max =', d_max, ' at g =', ngmax, ', i =', ij_max(1), ', j =', ij_max(2), ', d_avg =', d_avg
