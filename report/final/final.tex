...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/turbine_c_surface_cp.png}
    \caption{Turbine\_c test case results}
    \label{fig:turbine_c_surface_cp}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{figures/real_turbine_data.png}
    \caption{Real turbine data \cite{4A3_lab}}
    \label{fig:real_turbine_data}
\end{figure}
