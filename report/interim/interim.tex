...
Modifications were also made to the convergence criteria to stop the solver when the last 100 calculated \texttt{d\_avg} were all within 1\% of their mean.
This \texttt{d\_avg} is the average density residual (change) across all cells in the mesh for a given iteration.
